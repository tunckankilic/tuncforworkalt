          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ReusableText(
                      text: job.company,
                      style: appstyle(
                          18, Color(AppConstants.kDark.value), FontWeight.w600),
                    ),
                  ),
                ],
              ),
              ...
              ReusableText(
                text: job.location,
                style: appstyle(
                    16, Color(AppConstants.kDarkGrey.value), FontWeight.w600),
              ),
              ...
              Row(
                ...
                children: [
                  ReusableText(
                    ...
                    style: appstyle(
                        14, Color(AppConstants.kDark.value), FontWeight.w600),
                  ),
                  CircleAvatar(
                    radius: 18,
